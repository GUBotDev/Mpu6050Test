...
public class Mpu6050Registers {
     ...
     * measurement.
     */
    public static final byte MPU6050_RA_ACCEL_XOUT_H = XX;
    /**
     * 16-bit 2’s complement value. Stores the most recent X axis accelerometer
     * measurement.
     */
    public static final byte MPU6050_RA_ACCEL_XOUT_L = XX;
    /**
     * 16-bit 2’s complement value. Stores the most recent Y axis accelerometer
     * measurement.
     */
    public static final byte MPU6050_RA_ACCEL_YOUT_H = XX;
    /**
     * 16-bit 2’s complement value. Stores the most recent Y axis accelerometer
     * measurement.
     */
    public static final byte MPU6050_RA_ACCEL_YOUT_L = XX;
    /**
     * 16-bit 2’s complement value. Stores the most recent Z axis accelerometer
     * measurement.
     */
    public static final byte MPU6050_RA_ACCEL_ZOUT_H = XX;
    /**
     * 16-bit 2’s complement value. Stores the most recent Z axis accelerometer
     * measurement.
     */
    public static final byte MPU6050_RA_ACCEL_ZOUT_L = XX;
    /**
